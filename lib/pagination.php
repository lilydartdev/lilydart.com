<?php
/***
 * From dxw's govsite theme
 * https://github.com/dxw/govsite/blob/master/app/lib/pagination.php
**/
?>
...
function pagination($q = null, $mode = null) {
  ...
  if ( get_previous_posts_link() ) {
    ...
    printf( '<div class="previous btn-pagination"><a href="%s">&laquo; Previous</a></div>', $uri);
  }
  // next page
  if ( get_next_posts_link() ) {
    ...
    printf( '<div class="next btn-pagination"><a href="%s">Next &raquo;</a></div>', $uri);
  }
  // Restore $wp_query
  $wp_query = $old_wq;
